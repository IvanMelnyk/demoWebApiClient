...
{
    public partial class CustomScheme : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    password_hash = table.Column<string>(type: "varchar", maxLength: 128, nullable: true),
                    phone_number = table.Column<string>(nullable: true),
                    phone_number_confirmed = table.Column<bool>(nullable: false),
                    security_stamp = table.Column<string>(nullable: true),
                    two_factor_enabled = table.Column<bool>(nullable: false),
                    user_name = table.Column<string>(type: "varchar", maxLength: 128, nullable: true),
                    expire_time = table.Column<DateTimeOffset>(nullable: false),
                    first_name = table.Column<string>(type: "varchar", maxLength: 128, nullable: true),
                    join_date = table.Column<DateTimeOffset>(nullable: false),
                    last_name = table.Column<string>(type: "varchar", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
